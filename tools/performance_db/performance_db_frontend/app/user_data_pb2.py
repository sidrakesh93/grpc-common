...
_DATADETAILS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metrics', full_name='grpc.testing.DataDetails.metrics', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='client_config', full_name='grpc.testing.DataDetails.client_config', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='server_config', full_name='grpc.testing.DataDetails.server_config', index=4,
...
_SINGLEUSERRECORDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metrics', full_name='grpc.testing.SingleUserRecordRequest.metrics', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='client_config', full_name='grpc.testing.SingleUserRecordRequest.client_config', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='server_config', full_name='grpc.testing.SingleUserRecordRequest.server_config', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
